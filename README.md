...
---
🚀 How to Explore
Open `blinkit_project.pbix` in Power BI Desktop, or
View the interactive version via the Publish-to-Web link above (no login required)
Use the Outlet Location, Outlet Size, and Item Type slicers to filter the whole page
Use the Metric slicer to switch what the dynamic card/chart displays
Click any donut segment, bar, or funnel stage to cross-filter the rest of the report
Use the reset button to clear all filters back to the default view
---
📁 Repository Contents
```
...
![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white) ![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)
LinkedIn: linkedin.com/in/rkanhai
